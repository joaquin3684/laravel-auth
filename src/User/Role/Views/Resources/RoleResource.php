...
namespace Hitocean\LaravelAuth\User\Role\Views\Resources;
...
class RoleResource extends Resource
{
    ...
    {
        return [
            'index' => \Hitocean\LaravelAuth\User\Role\Views\Pages\ListRoles::route('/'),
            'create' => \Hitocean\LaravelAuth\User\Role\Views\Pages\CreateRole::route('/create'),
            'settings' => \Hitocean\LaravelAuth\User\Role\Views\Pages\ShieldSettings::route('/settings'),
            'view' => \Hitocean\LaravelAuth\User\Role\Views\Pages\ViewRole::route('/{record}'),
            'edit' => \Hitocean\LaravelAuth\User\Role\Views\Pages\EditRole::route('/{record}/edit'),
        ];
    }
